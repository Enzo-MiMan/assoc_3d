"""
input:
    .csv file path for raw data
    e.g.  ~/Documents/Github/indoor_data/2019-11-28-15-43-32/_slash_mmWaveDataHdl_slash_RScan_middle.csv

output:
    point cloud dictionary for a whole single sequence
    {timestamp: [[x, y, z, intensity, range, doppler], ...]}
"""
